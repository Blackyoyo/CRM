...
<BODY>
	<form id="form1" name="form1" action="${pageContext.request.contextPath }/linkman_query" method="post">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
								    <input type="radio" name="lkmGender" value='1'>男
                                    <input type="radio" name="lkmGender" value='2'>女
								</td>
							</TR>
							<TR>
								<td>联系人电话 ：</td>

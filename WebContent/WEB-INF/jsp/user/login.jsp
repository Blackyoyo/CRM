...
<script type="text/javascript">
    function registUI() {
        window.location = "${pageContext.request.contextPath }/registPage";
    }
</script>
<META content="MSHTML 6.00.6000.16809" name=GENERATOR></HEAD>
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/login" method=post target="_parent">
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD><INPUT id=btn1 
                  ...
                  type=image src="images/login_button.gif" name=btn1> 
              </TD></TR><TR>
                <TD></TD>
                <TD>
                    <img
                      onclick="registUI()"  src="images/regist_button.gif"> 

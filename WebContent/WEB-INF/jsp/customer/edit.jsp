...
$(document).ready(function(){
    ...
    $("#level").val('${customer.custLevel}');
    $("#source").val('${customer.custSource}');
    $("#industry").val('${customer.custIndustry}');
    $("#phone").val('${customer.custPhone}');
    $("#mobile").val('${customer.custMobile}');
});
</script>
...
<BODY>
	...
	<FORM name="form1" id="form1" action="${pageContext.request.contextPath }/customer_update?custId=${customer.custId}" method="post">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>信息来源：</td>
								<td>
								<INPUT class=textbox id=source
                                                        style="WIDTH: 180px" maxLength=50 name="custSource">
								</td>
								<td>联系人：</td>
								<td>
								<INPUT class=textbox id=industry
